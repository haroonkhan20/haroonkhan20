...
Currently deepening expertise in **AI Engineering** — LLMs, RAG pipelines, computer vision, and full-stack AI deployment.
...
|---|---|---|
| [SamBot — AI Chatbot](https://github.com/haroonkhan20/ai-engineer-journey) | Python · Flask · Groq API · LLaMA 3.3 | Full-stack AI chatbot with conversation memory and web UI |
| [AI Document Q&A](https://github.com/haroonkhan20/ai-engineer-journey) | HuggingFace · FAISS · DistilBERT · Gradio | Upload any PDF → ask questions → AI finds exact answers (RAG pipeline) |
...
**AI & ML**
`Python` `HuggingFace Transformers` `Sentence Transformers` `FAISS` `DistilBERT` `TFLite` `Scikit-learn` `Groq API` `LLaMA 3.3` `Flask` `Gradio`

**Computer Vision**
`OpenCV` `TFLite inference` `Real-time object detection` `EAR drowsiness detection` `Edge deployment`
...
**Tools**
`Git` `GitHub Actions` `Linux` `MATLAB Simulink` `VS Code`
